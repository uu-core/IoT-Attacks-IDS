...
<simconf>
  <simulation>
    <title>Controlled on-off validation: blackhole, 15 nodes, start 300 min, run 10</title>
...
while (elapsed &lt; 36000000) {
  ...
  if (elapsed + onTime &gt; 36000000) {
    onTime = 36000000 - elapsed;
  }
  ...
  if (elapsed + offTime &gt; 36000000) {
    offTime = 36000000 - elapsed;
  }
