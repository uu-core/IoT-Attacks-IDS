...
<simconf>
  <simulation>
    <title>Controlled on-off validation: blackhole, 15 nodes, start 600 min, run 10</title>
...
GENERATE_MSG(36000000, "attack_start");
...
while (elapsed &lt; 18000000) {
  ...
  if (elapsed + onTime &gt; 18000000) {
    onTime = 18000000 - elapsed;
  }
  ...
  if (elapsed + offTime &gt; 18000000) {
    offTime = 18000000 - elapsed;
  }
