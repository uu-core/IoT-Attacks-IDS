...
<simconf>
  <simulation>
    <title>Controlled on-off validation: blackhole, 15 nodes, start 450 min, run 10</title>
...
GENERATE_MSG(27000000, "attack_start");
...
while (elapsed &lt; 27000000) {
  ...
  if (elapsed + onTime &gt; 27000000) {
    onTime = 27000000 - elapsed;
  }
  ...
  if (elapsed + offTime &gt; 27000000) {
    offTime = 27000000 - elapsed;
  }
