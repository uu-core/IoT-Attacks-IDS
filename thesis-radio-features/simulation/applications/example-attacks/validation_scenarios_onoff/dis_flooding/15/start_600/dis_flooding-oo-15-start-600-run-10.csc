...
<simconf>
  <simulation>
    <title>Controlled on-off validation: dis_flooding, 15 nodes, start 600 min, run 10</title>
...
/* Controlled on-off validation begins at 600 minutes */
GENERATE_MSG(35995000, "attack_start");
