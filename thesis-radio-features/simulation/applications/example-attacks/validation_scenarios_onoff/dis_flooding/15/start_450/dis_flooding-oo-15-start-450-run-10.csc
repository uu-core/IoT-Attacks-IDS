...
<simconf>
  <simulation>
    <title>Controlled on-off validation: dis_flooding, 15 nodes, start 450 min, run 10</title>
...
/* Controlled on-off validation begins at 450 minutes */
GENERATE_MSG(26995000, "attack_start");
