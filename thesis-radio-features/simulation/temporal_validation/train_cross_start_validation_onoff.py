...
def main() -> None:
    ...
    parser.add_argument(
        "--data-root",
        type=Path,
        default=Path.home() / "ids-WPLR/applications/example-attacks/validation_outputs_onoff",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path.home() / "ids-WPLR/temporal_validation/cross_start_results_onoff",
    )
